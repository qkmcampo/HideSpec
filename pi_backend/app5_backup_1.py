...
# Do not reset all marker IDs because of one bad segmentation frame.
NO_LEATHER_RESET_FRAMES = 8
...
def inspection_worker():
    ...
    while True:
        ...
        if contour is not None:
            ...
            # A single segmentation miss must NOT erase defect IDs.
            # Reset only after the camera has been empty for several
            # consecutive frames and no hardware action is in progress.
            if (
                no_leather_frames >= NO_LEATHER_RESET_FRAMES
